  ...
  return (
    <div className=' h-auto w-full flex flex-col justify-start items-center'>
        <div className='h-auto w-full flex flex-col justify-center items-center'>
            <Navbar />
            <div className='w-full max-w-[1200px]  h-auto mt-44 flex flex-col'>
                <div className='w-full h-[350px] flex justify-between items-center gap-8'>
                    <div className='w-1/2 flex flex-col justify-center items-start gap-4'>
                      <div className='w-full max-w-[400px] bg-primary rounded-full h-12 text-white font-bold flex justify-center items-center text-xl'>
                        Agence de réalisation et de conseil
                      </div>
                      <div className='text-5xl justify-center items-center text-black font-bold'>
                      ...
                      <div className='flex justify-between items-center gap-4 w-full'>
                        <div className='flex justify-start items-center w-1/3 font-bold'>
                          <icons.BiSolidNotification className='text-primary text-xl' /> Site web internet
                        </div>
                    ...
                    <div className='w-1/2 flex flex-col  justify-center items-center border-4 border-primary rounded-3xl'>
                ...
                <div className='w-full flex justify-start items-center gap-8'>
                  <button className='hover:shadow-sm hover:shadow-black w-[250px] transform duration-300 flex gap-2 font-bold bg-primary rounded-full justify-center items-center text-white px-4'>
                    Prendre rendez-vous
            ...
            <div className='w-full max-w-[1200px]  flex justify-between gap-8 items-center mt-32'>
              <div className='w-2/3 flex flex-col justify-center items-start gap-4'>
                ...
                <div className='w-[100px] text-3xl bg-primary rounded-xl text-white font-bold flex justify-center items-center h-12 '>
                  mais...
                </div>
                <div className='flex justify-start items-center gap-4 w-full'>
                  ...
                  <div className='w-11/12 max-w-[500px] font-bold'>
            ...
            <div className='h-auto py-10 w-full bg-secondary mt-32 flex justify-center items-center'>
              <div className='max-w-[1200px] w-full flex gap-6 flex-col justify-start items-center h-full'>
                <div className='text-4xl font-bold text-white'>
                  Pourquoi
                </div>
                <div className='p-4 -rotate-3 bg-primary rounded-xl flex justify-center items-center font-bold text-white text-6xl '>
                  DevMasterMind
                </div>
                <div className='h-10 border-2 rounded-full w-[120px] text-white font-bold flex justify-center items-center '>
                  Raison 01
                </div>
                ...
                <div className='flex gap-4 w-full justify-center items-center'>
                  <div className='gap-2 w-1/3 h-[230px] border-2 rounded-xl flex flex-col justify-start items-center p-4 '>
                    <div className='w-[60px] h-[60px] bg-primary rounded-xl flex justify-center items-center '>
                      <div className='border-[3px] h-[45px] w-[45px] rounded-full flex justify-center items-center  '>
                ...
                <div className='flex gap-10 w-full justify-between items-center'>
                  <div className='flex flex-col w-1/3 justify-start items-center gap-4'>
                    <div className='h-10 border-2 rounded-full w-[120px] text-white font-bold flex justify-center items-center '>
                      Raison 02
                    </div>
                    ...
                    <div className='text-white text-justify font-thin'>
            ...
            <div className='w-full max-w-[1200px]  flex flex-col justify-start gap-8 items-start my-20'>
              <div className='w-2/3 flex flex-col justify-center items-start gap-4'>
                <div className='text-3xl text-black font-bold'>
                  Quelques-unes de nos 
                </div>
                <div className='w-[300px] text-3xl bg-primary rounded-xl text-white font-bold flex justify-center items-center h-12 '>
                  Success stories
                </div>
              </div>
              <div className='w-full flex justify-between items-center gap-10 '>
                <div className='w-1/3 flex flex-col justify-center items-start gap-4'>
                  ...
                  <NavLink className='w-full max-w-[250px] bg-primary flex justify-center items-center gap-4 text-white font-bold text-xl rounded-full'>
                    Voir le projet <icons.HiArrowLongRight className='text-white' />
                  </NavLink>
                </div>
                <div className='w-1/3 flex flex-col justify-center items-start gap-4'>
            ...
            <div className='bg-primary-10 flex flex-col justify-start items-center w-full h-auto py-10'>
              <div className='max-w-[1200px] w-full flex gap-6 flex-col justify-start items-center h-full'>
                <div className='text-4xl font-bold text-white'>
                  Ils nous ont fait
                </div>
                ...
                <div className='flex flex-wrap w-full gap-y-10 gap-x-4 justify-between items-center mt-10'>
                  <div className='w-1/5 bg-white rounded-xl h-24'>
                ...
                <div className='w-full flex justify-between items-center gap-10 mt-32'>
                  <div className='w-1/3 flex flex-col justify-center items-center h-24 text-white font-bold '>
                    <span>+150</span>
                ...
                <div className='w-full flex flex-col justify-center items-center mt-32 gap-10'>
                  ...
                  <div className='w-full flex flex-wrap justify-center items-center gap-y-10 gap-x-4'>
                    <div className='w-1/5 bg-white rounded-xl h-24'>
            ...
            <div className='w-full max-w-[1200px] flex px-10 justify-center items-center bg-primary h-60 mt-32 rounded-xl mb-32'>
                <div className='flex flex-col justify-start items-start w-1/2 gap-4'>
                 <span className='text-white text-3xl font-bold '>Échangeons sur votre projet !</span>
                 <div className='flex justify-start items-start gap-4 w-full'>
                    <div className='flex justify-start items-center w-1/3 font-bold text-white'>
                      <icons.BiSolidNotification className='text-xl' /> Site web internet
                    </div>
                    <div className='flex justify-center items-center w-1/3 font-bold text-white'>
                      <icons.BiSolidNotification className='text-xl' /> Site web internet
                    </div>
                    <div className='flex justify-center items-center w-1/3 font-bold text-white'>
                      <icons.BiSolidNotification className='text-xl' /> Site web internet
                ...
                <div className='w-1/2 flex justify-end items-center'>
                  <NavLink className='w-full max-w-[350px] bg-white h-12 rounded-full flex justify-center items-center gap-4 text-primary font-bold hover:shadow-black shadow-md duration-300 hover:gap-24'>
                    Nous contacter
