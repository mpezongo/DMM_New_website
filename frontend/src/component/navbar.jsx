...
export default function Navbar() {
  ...
  return (
      <div
          className='w-full bg-transparent px-2 md:px-0 fixed top-12 md:top-20 max-w-[1200px] h-14 md:h-20 -translate-x-1/2 -translate-y-1/2 left-1/2 z-50'>
          <div
              ...
              <div className='w-1/5 h-full md:hidden flex justify-start items-center pl-5 cursor-pointer'
              ...
              <div className='hidden w-3/5 h-full md:flex justify-center items-center gap-4'>
                  <NavLink className="w-1/5 flex justify-center items-center font-bold relative group" to="/services">
                      ...
                      <div
                          className="absolute bottom-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-0 h-[2px] bg-black transition-all duration-300 group-hover:w-[75%]"></div>
                  </NavLink>
                  ...
                  <NavLink className="w-1/5 flex justify-center items-center font-bold relative group">
                      ...
                      <div
                          className="absolute bottom-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-0 h-[2px] bg-black transition-all duration-300 group-hover:w-full"></div>
                  </NavLink>
                  ...
                  <NavLink className="w-1/5 flex justify-center items-center font-bold relative group">
                      <span>A propos</span>
                      <div
                          className="absolute bottom-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-0 h-[2px] bg-black transition-all duration-300 group-hover:w-[65%]"></div>
                  </NavLink>
              </div>
              <div className='w-[150px] md:w-1/5 h-full justify-end items-center flex pr-2 md:pr-10'>
                  <button
                      className='flex justify-center items-center rounded-full font-bold text-white text-[12px] md:text-xl w-[90%] bg-primary h-12'>
                      Nous contacter <icons.MdOutlineArrowRightAlt className='text-3xl top-1 relative flex'/>
                  </button>
              </div>
          </div>
          <div
              className={'z-10 fixed w-[50%] h-screen flex flex-col items-center bg-white shadow-sm shadow-black -top-5 md:hidden duration-1000 ' + (open ? 'left-0' : '-left-full')}>
